 ...
 * @summary Get pages
 */
export const prefetchGetPages = async <TData = Awaited<ReturnType<typeof getPages>>, TError = unknown>(
 ...
 * @summary Get packages
 */
export const prefetchGetPackages = async <TData = Awaited<ReturnType<typeof getPackages>>, TError = unknown>(
