...
const ViewInvoiceButton: FC<{ invoice: any; billingInfo: any }> = ({ invoice, billingInfo }) => {
  ...
  return (
    <Stack direction="row" gap={0.5} alignItems="center" onClick={handlePreview} sx={{ cursor: "pointer" }}>
      <Icon name={isGenerating ? "Loading" : "Eye-On"} />
