...
type InvoiceDocumentProps = {
  ...
  billingInfo?: BillingAddressResponse;
};
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.pageWrap}>
          ...
          {/* Invoice Items */}
          <View>
            <View style={{ ...styles.row, borderBottom: "1px solid lightgrey", marginBottom: 10, paddingBottom: 10 }}>
            ...
            <View style={styles.row}>
              <Text style={styles.boldText}>{`${toTitleCase(invoice.plan_type)} Package`}</Text>
              <View style={{ ...styles.row, gap: 50, width: 200 }}>
