...
const Germany = () => {
  return (
    <SvgWrapper>
      <g clipPath="url(#clip0_7029_34645)">
        <path
          d="M0.746094 16.1743C2.44161 20.7439 6.84012 24.0004 11.9997 24.0004C17.1593 24.0004 21.5578 20.7439 23.2533 16.1743L11.9997 15.1309L0.746094 16.1743Z"
          fill="#FFDA44"
        />
        <path
