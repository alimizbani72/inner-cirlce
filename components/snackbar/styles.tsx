...
export const StyledToaster = styled(Toaster)(({ theme }) => {
  ...
  const loadingStyles = {
    ...
    [`& .${toasterClasses.loadingIcon}`]: {
      ...
      background: `conic-gradient(${varAlpha(theme.vars.palette.text.primary, 0)}, ${varAlpha(theme.vars.palette.text.disabled, 0.64)})`,
    },
  ...
  return {
    ...
    [`& .${toasterClasses.closeButton}`]: {
      ...
      borderColor: varAlpha(theme.vars.palette.grey['light'], 0.16),
      transition: theme.transitions.create(['background-color', 'border-color']),
      '&:hover': {
        borderColor: varAlpha(theme.vars.palette.grey['light'], 0.24),
