  ...
  const renderPlaceholder = (
    <Box
      ...
      sx={{
        ...
        bgcolor: (theme) => varAlpha(theme.palette.grey['light'], 0.08),
        transition: (theme) =>
        ...
        ...(hasFile && {
          ...
          opacity: 0,
          color: 'common.white',
          bgcolor: (theme) => varAlpha(theme.palette.grey['dark'], 0.64),
        }),
      }}
    >
    ...
    <>
      <Box
        ...
        sx={{
          ...
          overflow: 'hidden',
          borderRadius: '50%',
          border: (theme) => `1px dashed ${varAlpha(theme.palette.grey['light'], 0.2)}`,
