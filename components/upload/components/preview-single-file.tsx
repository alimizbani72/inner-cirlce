  ...
  return (
    <IconButton
      ...
      sx={{
        ...
        zIndex: 9,
        position: 'absolute',
        color: (theme) => varAlpha(theme.vars.palette.common.white, 0.8),
        bgcolor: (theme) => varAlpha(theme.vars.palette.grey['dark'], 0.72),
        '&:hover': { bgcolor: (theme) => varAlpha(theme.vars.palette.grey['dark'], 0.48) },
        ...sx,
      }}
      {...other}
    >
