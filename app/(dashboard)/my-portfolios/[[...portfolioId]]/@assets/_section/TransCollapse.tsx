...
import { useGetPortfolioTransactions } from '@/services/minecraft/portfolio/portfolio';
...
const TransCollapse: FC<TransCollapseProps> = ({ slug, colSpan, isClose, symbol, name, logo }) => {
  ...
  const { data: transactions, isLoading: transactionsLoading } = useGetPortfolioTransactions(
    {
      opts: JSON.stringify({
        filters: {
          slug,
