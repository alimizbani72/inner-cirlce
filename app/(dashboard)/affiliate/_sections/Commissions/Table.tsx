  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        modify: (row: any) => toTitleCase(row.plan_type),
      },
      {
        title: t("affCommissionsTabTable.percentage"),
        modify: (row: any) => toNumber(row.percent),
      },
      {
            ...
            >
              <Stack gap={2}>
                ...
                <input
                  type="date"
                  onChange={(e) =>
                    setDates((s: any) => [new Date(e.target.value), s?.[1]])
                  }
                />
                ...
                <input
                  type="date"
                  onChange={(e) =>
                    setDates((s: any) => [s?.[0], new Date(e.target.value)])
                  }
                />
              </Stack>
            </CustomPopover>
