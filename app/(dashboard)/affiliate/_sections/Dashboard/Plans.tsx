  ...
  const children = {
    data: {
      distribution_of_plans: [
        { plan_type: "plankton", count: 12 },
        { plan_type: "shrimp", count: 8 },
        { plan_type: "shell", count: 5 },
        { plan_type: "fish", count: 3 },
        { plan_type: "shark", count: 3 },
        { plan_type: "whale", count: 1 },
      ],
    },
  };
  ...
  return (
    ...
    >
      <Scrollbar>
        ...
        >
          {orderArrayPlan(children?.data?.distribution_of_plans)?.map(
            (item, index) => {
              ...
              const bgColor =
                isMobileDarkBg || isDesktopDarkBg ? "dark.3" : undefined;
                  ...
                  {(plans as any)[item.plan_type!]?.rive && (
                    <Box sx={{ aspectRatio: 1 }}>
                      <RiveComp
                        width={80}
                        height={80}
                        src={(plans as any)[item.plan_type!]?.rive}
                      />
                    </Box>
                  )}
