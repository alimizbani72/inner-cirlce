...
type ContractDocumentProps = {
  info: AuthHttpBusinessInfoResponse | undefined;
};
      ...
      >
        ...
        >
          ...
          >
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 3 }}>
              ...
              <Text style={{ fontSize: 14, fontWeight: 'semibold', color: 'white' }}>
                AG Official Affiliate
              </Text>
            </View>
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 3 }}>
              <Text style={{ fontSize: 14, fontWeight: 'semibold', color: 'white' }}>
        ...
        >
          ...
          <View style={{ display: 'flex', flexDirection: 'column', marginTop: 16 }}>
            <Text
              style={{ fontSize: 12, fontWeight: 'semibold', color: '#070720', marginBottom: 8 }}
            >
            ...
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 3 }}>
              ...
              <Text style={{ fontSize: 12, fontWeight: 'medium', color: '#070720' }}>
                {info?.holder_name}
              </Text>
            </View>
        ...
        >
          ...
          >
            This document serves as an official confirmation that the aforementioned company and
            account holder have entered into a formal affiliate partnership with ChainMind AG. The
            affiliate is authorized to promote and collaborate with ChainMind AG as an independent
            affiliate partner, who promotes our products and services to his network in accordance
            with the terms and conditions of our partnership agreement.
          </Text>
          ...
          >
            This partnership is established under Swiss law and is recognized for official purposes,
            including taxation and other legal requirements. ChainMind AG verifies that this
            affiliate relationship is valid and that all required information is accurate as of the
            date of issuance.
          </Text>
          ...
          >
            ...
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 3 }}>
              <Text
                style={{ fontSize: 10, lineHeight: '2.4', fontWeight: 'medium', color: '#404365' }}
              >
                Authorized Signatory:
              </Text>
              <Text
                style={{ fontSize: 10, lineHeight: '2.4', fontWeight: 'medium', color: '#070720' }}
              >
                Christian Brom | CEO
              </Text>
            </View>
