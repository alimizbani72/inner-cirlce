...
import { getGetMeQueryKey, useGetMe } from '@/services/minecraft/auth/auth';
import { usePatchBusinessInfo } from '@/services/minecraft/user/user';
...
const BusinessAccountDialog: FC<BusinessAccountDialogProps> = ({ open, close }) => {
  ...
  const { mutateAsync, isPending } = usePatchBusinessInfo();
